...
macro(get_libraries_for_system _LIBRARY_LIST SYSTEM_ID)
	...
	foreach(INDEX RANGE ${_MAX_LIBRARY_INDEX})
		...
		set(${_LIB_NAME}_SYSTEMID ${SYSTEM_ID} PARENT_SCOPE)
...
function(parse_components_config)
	...
	if (LIBRARY_CONF MATCHES .*\\.json)
		...
		# Get libraries and their properties for the current system.
		string(JSON _LIBRARY_LIST GET ${LIBRARY_CONF_JSON} ${SYSTEMID})
		get_libraries_for_system(${_LIBRARY_LIST} ${SYSTEMID})

		# Check if there are any libraries for SystemID "All". If so, get their properties.
		string(JSON _LIBRARY_LIST ERROR_VARIABLE JSON_ERROR GET ${LIBRARY_CONF_JSON} "All")
		if(NOT JSON_ERROR)
			get_libraries_for_system(${_LIBRARY_LIST} "All")
		endif()
	else()
