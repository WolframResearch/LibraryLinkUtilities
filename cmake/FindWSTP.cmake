...
if(WSTP_INCLUDE_DIR)
	file(STRINGS "${WSTP_INCLUDE_DIR}/wstp.h" _WOLFSTP_HEADER_CONTENTS REGEX "#define ML[A-Z]+ ")
	string(REGEX REPLACE ".*#define MLINTERFACE ([0-9]+).*" "\\1" WSTP_VERSION_MAJOR "${_WOLFSTP_HEADER_CONTENTS}")
	string(REGEX REPLACE ".*#define MLREVISION ([0-9]+).*" "\\1" WSTP_VERSION_MINOR "${_WOLFSTP_HEADER_CONTENTS}")
