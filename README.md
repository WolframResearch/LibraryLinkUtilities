...
Currently the best way to include LLU into your project is by using git submodule. Submodules are simply git repos inside other repos but working with them may sometimes be tricky. I recommend this excellent [tutorial on submodules](https://git-scm.com/book/en/v2/Git-Tools-Submodules).
