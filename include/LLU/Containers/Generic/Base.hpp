...
namespace LLU {
	...
	protected:
		...
		void disown() const noexcept {
			...
			if constexpr (Type == MArgumentType::DataStore || Type == MArgumentType::DataVector) {
				// Disowning does nothing for DataStore and DataVector as they can't be shared.
		...
		void free() const noexcept {
			...
			} else if constexpr (Type == MArgumentType::DataVector) {
				LibraryData::DataVectorAPI()->DataVector_release(container);
			} else if constexpr (Type == MArgumentType::Image) {
