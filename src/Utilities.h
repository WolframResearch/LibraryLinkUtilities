	...
	void applyToRawArray(rawarray_t raType, Callable&& f, Args&&... args) {
		switch (raType) {
			case MRawArray_Type_Bit8:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Bit8>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Ubit8:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Ubit8>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Bit16:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Bit16>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Ubit16:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Ubit16>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Bit32:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Bit32>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Ubit32:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Ubit32>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Bit64:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Bit64>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Ubit64:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Ubit64>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Real32:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Real32>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Real64:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Real64>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Float_Complex:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Float_Complex>::type>(std::forward<Args>(args)...);
				break;
			case MRawArray_Type_Double_Complex:
				std::forward<Callable>(f).template operator()<RawArrayFromEnum<MRawArray_Type_Double_Complex>::type>(std::forward<Args>(args)...);
				break;
			default:
				return;
		}
